...
Open source [OpenTelemetry instrumentation](https://opentelemetry.io/docs/languages/js/instrumentation/) package for the [Dust SDK](https://github.com/dust-tt/dust) that automatically captures agent interactions as distributed traces using the [GenAI Semantic Conventions](https://opentelemetry.io/docs/specs/semconv/gen-ai/). Monitor agent performance, track tool executions, debug failures, and analyze conversation patterns in production.
